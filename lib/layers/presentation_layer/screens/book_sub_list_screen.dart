...
import 'package:islamisbest/layers/presentation_layer/screens/pdfViewer.dart';
...
class BookSublistScreen extends StatelessWidget {
  ...
  final String about;
  final String link;
  BookSublistScreen({this.image, this.name, this.about, this.link});
