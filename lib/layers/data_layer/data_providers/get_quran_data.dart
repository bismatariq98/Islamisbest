...
import 'package:islamisbest/layers/data_layer/models/ayat_model.dart';
import 'dart:convert';

import 'package:islamisbest/layers/data_layer/models/surah_model.dart';
...
class GetQuranData {
  ...
  Future<List<AyahsModel>> getQuranAyahData({String name}) async {
    String url = "https://api.alquran.cloud/v1/quran/en.asad";
    http.Response response = await http.get(url);
    var responseData = jsonDecode(response.body);
    if (responseData["status"] == "OK") {
